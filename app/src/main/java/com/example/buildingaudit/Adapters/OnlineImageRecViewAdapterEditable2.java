...
public class OnlineImageRecViewAdapterEditable2 extends RecyclerView.Adapter<OnlineImageRecViewAdapterEditable2.HistoryItemViewHolder> {
    Context context;
    ArrayList<String> imageUrlString;
    public static ArrayList<String> deletedUrls=new ArrayList<>();
    public OnlineImageRecViewAdapterEditable2(Context context, ArrayList<String> staffPhotoPathList) {
