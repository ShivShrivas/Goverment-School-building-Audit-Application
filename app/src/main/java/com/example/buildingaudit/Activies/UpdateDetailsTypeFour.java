...
EditText edtExpenditure,edtNumberOfBooksLibrary,numberOfAlmira,edtLibraryGrantInFY,edtTotalLibraryGrant;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonSubmitLibraryDetails=findViewById(R.id.buttonSubmitLibraryDetails);
       ...
       arrayAdapter2=new ArrayAdapter<>(this, android.R.layout.simple_spinner_item,arrayListWorkingStatus);
        ...
        typeFourImageUploadBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Dexter.withContext(UpdateDetailsTypeFour.this)
...
//                                                    .compressToFile(imageFile);
                                            ...
                                            Uri imageUri= FileProvider.getUriForFile(UpdateDetailsTypeFour.this,"com.example.buildingaudit.provider",imageFile);
                                    ...
                                    AlertDialog.Builder builder = new AlertDialog.Builder(UpdateDetailsTypeFour.this);
