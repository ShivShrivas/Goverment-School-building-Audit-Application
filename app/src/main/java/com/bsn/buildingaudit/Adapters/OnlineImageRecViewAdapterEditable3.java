...
public class OnlineImageRecViewAdapterEditable3 extends RecyclerView.Adapter<OnlineImageRecViewAdapterEditable3.HistoryItemViewHolder> {
    Context context;
    ArrayList<String> imageUrlString;
    public static ArrayList<String> deletedUrls=new ArrayList<>();
    public OnlineImageRecViewAdapterEditable3(Context context, ArrayList<String> staffPhotoPathList) {
