...
public class UpdateDetailsPrincipalRoom extends AppCompatActivity {
    ...
    RecyclerView recyclerViewprincipal,recyclerViewprincipalFromServer;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerViewprincipalFromServer=findViewById(R.id.recyclerViewprincipalFromServer);
        if (action.equals("3")){
        ...
        principalImageUploadBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Dexter.withContext(UpdateDetailsPrincipalRoom.this)
...
//                                                    .compressToFile(imageFile);
                                            ...
                                            Uri imageUri= FileProvider.getUriForFile(UpdateDetailsPrincipalRoom.this,"com.bsn.buildingaudit.provider",imageFile);
                                    ...
                                    AlertDialog.Builder builder = new AlertDialog.Builder(UpdateDetailsPrincipalRoom.this);
    ...
    private void fetchAllDataFromServer() {
        ...
        call.enqueue(new Callback<List<JsonObject>>() {
            ...
            public void onResponse(Call<List<JsonObject>> call, Response<List<JsonObject>> response) {
                ...
                recyclerViewprincipalFromServer.setLayoutManager(new LinearLayoutManager(UpdateDetailsPrincipalRoom.this,LinearLayoutManager.HORIZONTAL,false));
                ...
                OnlineImageRecViewAdapterEditable onlineImageRecViewAdapter=new OnlineImageRecViewAdapterEditable(UpdateDetailsPrincipalRoom.this,aList);
                recyclerViewprincipalFromServer.setAdapter(onlineImageRecViewAdapter);
            }
    ...
    private String paraPrincipal(String s, String s1, String principalRoomDetails, String toString, String toString1, String latitude, String longitude, String schoolId, String periodID, String usertypeid, String userid, ArrayList<File> arrayListImages1) {
        JsonObject jsonObject=new JsonObject();
