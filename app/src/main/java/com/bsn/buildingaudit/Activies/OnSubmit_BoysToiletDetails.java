...
public class OnSubmit_BoysToiletDetails extends AppCompatActivity {
    ...
    Button boysToiletApproveBtn,boysToiletRejectBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        boysToiletApproveBtn=findViewById(R.id.boysToiletApproveBtn);
        boysToiletRejectBtn=findViewById(R.id.boysToiletRejectBtn);
            ...
            callz.enqueue(new Callback<ApproveRejectRemarksDataModel>() {
                ...
                public void onResponse(Call<ApproveRejectRemarksDataModel> call, Response<ApproveRejectRemarksDataModel> response) {
                    ...
                    if (!approveRejectRemarksDataModel.getStatus().equals("No Record Found")) {
                        ...
                        Toast.makeText(OnSubmit_BoysToiletDetails.this, "" + approveRejectRemarksDataModel.getStatus(), Toast.LENGTH_SHORT).show();

                        arrayListRemarks = approveRejectRemarksDataModel.getData();
                        Dialog dialogForRemark = new Dialog(OnSubmit_BoysToiletDetails.this);
        ...
        boysToiletRejectBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ...
                call1.enqueue(new Callback<ArrayList<ApproveRejectRemarkModel>>() {
                    ...
                    public void onResponse(Call<ArrayList<ApproveRejectRemarkModel>> call, Response<ArrayList<ApproveRejectRemarkModel>> response) {
                        ...
                        StaticFunctions.showDialogReject(OnSubmit_BoysToiletDetails.this,arrayList,applicationController.getPeriodID(),applicationController.getSchoolId(),ParentID,arrayListRemarks,remarkAlreadyDoneFlag,InspectionId);
        ...
        boysToiletApproveBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ...
                call1.enqueue(new Callback<ArrayList<ApproveRejectRemarkModel>>() {
                    ...
                    public void onResponse(Call<ArrayList<ApproveRejectRemarkModel>> call, Response<ArrayList<ApproveRejectRemarkModel>> response) {
                        ArrayList<ApproveRejectRemarkModel> arrayList=response.body();
                        StaticFunctions.showDialogApprove(OnSubmit_BoysToiletDetails.this,arrayList,applicationController.getPeriodID(),applicationController.getSchoolId(),ParentID,arrayListRemarks,remarkAlreadyDoneFlag,InspectionId);
