            ...
            public void onClick(View view) {
                ...
                call1.enqueue(new Callback<ArrayList<ApproveRejectRemarkModel>>() {
                    ...
                    public void onResponse(Call<ArrayList<ApproveRejectRemarkModel>> call, Response<ArrayList<ApproveRejectRemarkModel>> response) {
                        ...
                        StaticFunctions.showDialogApprove(OnSubmit_Officeroom.this,arrayList,applicationController.getPeriodID(),applicationController.getSchoolId(),ParentID);
        ...
        officeRoomRejectBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                call1.enqueue(new Callback<ArrayList<ApproveRejectRemarkModel>>() {
                    ...
                    public void onResponse(Call<ArrayList<ApproveRejectRemarkModel>> call, Response<ArrayList<ApproveRejectRemarkModel>> response) {
                        ArrayList<ApproveRejectRemarkModel> arrayList=response.body();
                        StaticFunctions.showDialogReject(OnSubmit_Officeroom.this,arrayList,applicationController.getPeriodID(),applicationController.getSchoolId(),ParentID);
